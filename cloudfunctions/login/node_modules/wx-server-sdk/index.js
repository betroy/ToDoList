...
var Cloud = /** @class */ (function () {
    ...
    Cloud.prototype.getOverriddenConfig = function (config) {
                    ...
                    if (res.code && error_config_1.TCB_ERR_CODE[res.code] !== 0) {
                        ...
                        fileList = (res.fileList || []).filter(function (s) { return Boolean(s); }).map(function (f) {
                            if (f.code && error_config_1.TCB_ERR_CODE[f.code] !== 0) {
                                var code = error_config_1.TCB_ERR_CODE[res.code] || error_config_1.TCB_ERR_CODE.SYS_ERR;
                                return {
                                    fileID: f.fileID,
                                    status: error_config_1.TCB_ERR_CODE[res.code] || error_config_1.TCB_ERR_CODE.SYS_ERR,
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    statusCode = 200;
                    return [4 /*yield*/, tcb.downloadFile({
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, tcb.getTempFileURL({
                            fileList: options.fileList,
                        })];
                case 2:
                    res = _a.sent();
...
function callFunction(options) {
    ...
    return new Promise(function (resolve, reject) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var dataStr, result, parsedResult, e_1, error;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!options) {
                    ...
                    try {
                        dataStr = options.data ? JSON.stringify(options.data) : '';
                    }
                    catch (e) {
                        return [2 /*return*/, reject(error_1.returnAsFinalCloudSDKError(e, apiName))];
                    }
